    ...
    data () {
      return {
        ...
        cards: [
            ...
            { title: 'Pollo', src: require('../../static/img/favoritas/pizza2.jpg'), precio:'35000', flex: 6 },
            { title: 'Morcilla', src: require('../../static/img/favoritas/pizza3.jpg'), precio:'40000', flex: 6 },
        ],
      }
    },
}
